source = src
obj = ModIntVec.o ModVec.o ModMtrx.o MerTwist.o Main.o
...
opt_gnu = -J./obj_gnu -I./obj_gnu -O3 -Wall -Wno-integer-division -Wno-uninitialized -Wno-unused-function -Wno-unused-dummy-argument -fimplicit-none
